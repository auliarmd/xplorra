...
function EditResep() {
 ...
 useEffect(() => {
  ...
  // sinkronkan saat halaman pertama kali dibuka
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await api.put(`/edit-food/${id}`, formData, {
        headers: {
  ...
  const hapusBahan = (index) => {
    const data = bahan.filter((_, i) => i !== index);
    setBahan(data);
  };
  ...
  const hapusLangkah = (index) => {
    const data = langkah.filter((_, i) => i !== index);
    setLangkah(data);
  };
    ...
    menu
          ...
          <>
            ...
            <div style={styles.headerCenter}>
              <div style={styles.headerTitle}>Edit Resep</div>
            </div>
      ...
      {/* SIDEBAR DRAWER MOBILE (Menyesuaikan dengan Gambar) */}
     {/* ================= MOBILE SIDEBAR ================= */}
{isMobile && (
  <div
    style={{
        ...
        >
          ...
          >
            <button
              ...
              style={{
                ...styles.cancelBtn,
                background: hoverCancel ? "#E46B5C" : "transparent",
                color: hoverCancel ? "#fff" : "#b87944",
                border: hoverCancel ? "1px solid #E46B5C" : "1px solid #b87944",
          ...
          {showSuccessPopup && (
            <div style={styles.popupOverlay}>
              <div style={styles.popupBox}>
                ...
                <h2 style={styles.popupTitle}>Berhasil!</h2>

                <p style={styles.popupText}>Resep berhasil diperbaharui.</p>
              </div>
            </div>
          )}
        </div>
...
mobileMenuItem: {
 ...
 mobileMenuHeader: {
  ...
  page: {
    minHeight: "100vh",
    background: `linear-gradient(to bottom, #F4E9DC 0%, #D49A75 100%)`,
    position: "relative",
    overflow: "hidden",
 ...
 hamburgerBtn: {
  ...
  width: "42px",
  height: "42px",
  marginLeft: "12px",   // Geser ke kanan
  cursor: "pointer",
},
